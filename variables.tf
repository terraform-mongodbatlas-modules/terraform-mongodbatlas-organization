...
variable "resource_policies" {
  description = "Resource policy configuration. Set enabled = true to activate the resource_policy submodule. Secure-by-default policies (block_wildcard_ip, require_maintenance_window) default to true."
  type = object({
