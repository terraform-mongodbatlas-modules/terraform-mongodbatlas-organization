...
Description: Resource policy configuration. Set enabled = true to activate the resource\_policy submodule. Secure-by-default policies (block\_wildcard\_ip, require\_maintenance\_window) default to true.
