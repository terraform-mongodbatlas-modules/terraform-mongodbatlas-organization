...
- **[`create`](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-organization/blob/v0.2.0/modules/create)**: Provisions a new organization and optionally applies resource policies.
- **[`existing`](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-organization/blob/v0.2.0/modules/existing)**: Manages resource policies for an organization that already exists.
...
|----------|---------|-------------|
| **Manage resource policies for an already existing organization** | [`existing-org/`](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-organization/blob/v0.2.0/examples/existing-org) | Applies resource policies to an organization that already exists in MongoDB Atlas. |
| **Create new organization (single apply)** | [`new-org-single-apply/`](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-organization/blob/v0.2.0/examples/new-org-single-apply) | Creates a new organization and apply policies in a single `terraform apply` command. |
| **Create new organization (two-step)** | [`new-org-two-step/`](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-organization/blob/v0.2.0/examples/new-org-two-step) | Creates a new organization and apply policies in separate steps. Note: Use this when you cannot use the single-apply workflow. |
| **Import existing organization** | [`import/`](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-organization/blob/v0.2.0/examples/import) | Import an already-existing MongoDB Atlas organization into your Terraform state. |
| **Bootstrap workforce federation IdP (once per federation)** | [`federation-workforce-idp-okta/`](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-organization/blob/v0.2.0/examples/federation-workforce-idp-okta) | Bootstrap a federation-level Okta SAML workforce IdP (once per federation). |
| **Configure workforce federation on an existing organization** | [`federated-workforce-org/`](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-organization/blob/v0.2.0/examples/federated-workforce-org) | Configure `org_config` and role mappings on an existing org linked to federation settings. |
...
If importing existing MongoDB Atlas organizations, use the [`import` example](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-organization/blob/v0.2.0/examples/import) to bring them into your Terraform state. See [Terraform import](https://developer.hashicorp.com/terraform/cli/import) for general guidance.
...
See [LICENSE](https://github.com/terraform-mongodbatlas-modules/terraform-mongodbatlas-organization/blob/v0.2.0/LICENSE) for full details.
